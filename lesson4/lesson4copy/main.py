...
for url in fests_urls_list:
    ...
    try:
        ...
        contact_details = soup.find("h2", string="Venue contact detals and info").find_next()
        ...
        for contact_detail in items:
            ...
            if len(contact_detail_list) == 3:
                ...
                contact_details_dict[contact_detail_list[0].strip()] = contact_detail.list[1].strip()
